...
func StartPluginAtPath(socketPath string, endpoint interface{}, shutdown ...func() error) (chan<- struct{}, <-chan error, error) {
	return StartPluginAtPathWithRPCServices(socketPath, []interface{}{endpoint}, shutdown...)
}

// StartPluginAtPathWithRPCServices takes multiple rpc service object and binds their methods to the plugin server
func StartPluginAtPathWithRPCServices(socketPath string, endpoints []interface{}, shutdown ...func() error) (chan<- struct{}, <-chan error, error) {
