...
export STORAGE_ENDPOINT="variables('storageEndpoint')"
export RESOURCE_MANAGER_ENDPOINT="variables('resMgrUrl')"
export ACTIVE_DIRECTORY_ENDPOINT="variables('adUrl')"
export SERVICE_MANAGEMENT_ENDPOINT="variables('svcMgmtUrl')"
