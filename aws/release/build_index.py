...
def build_index(bucket_path, results_file, title):
    ...
    html = "<!DOCTYPE html><html lang='en'><head><meta charset='utf-8'><meta http-equiv='X-UA-Compatible' content='IE=edge'><meta name='viewport' content='width=device-width, initial-scale=1'><title>{0} nightly buiilds</title>{1}</head><body><div class='container'><h1>{0} nightly builds</h1><table class='table'><tr><th>Day</th><th>Last modified</th><th>Launch</th></tr>".format(title, css)
    ...
    if os.path.exists(results_file):
        ...
        html += "<tr><td colspan='3'>Not available</td></tr>"
...
build_index("aws/nightly-ddc/", "ddc_results", "DDC on Docker for AWS")
