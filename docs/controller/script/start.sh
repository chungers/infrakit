...
INFRAKIT_MANAGER_CONTROLLERS=pool,resource,script \
infrakit plugin start manager:mystack vars group pool resource script simulator:az1 \
	 --log 5 --log-stack --log-debug-V 500 \
	 --log-debug-match module=controller/script \
